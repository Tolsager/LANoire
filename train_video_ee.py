...
if __name__ == '__main__':
    ...
    ds = dataset.LANoireVideoDataset(json_path="/work3/s204135/data/raw/data.json", num_frames=num_frames)
    ...
    wandb_logger = utils.setup_logger(tags=["unimodal", "video", "end-to-end"], config={"lr": lr, "batch_size": batch_size}, note=model_arch)
